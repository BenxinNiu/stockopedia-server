...
public class InventoryConsolidator {
    ...
    public InventoryConsolidator(String _id, String ticker, String company_name, String legal_entity_identifier, String central_index_key, String latest_filing_date, String supported) {
        this._id = _id;
        this.ticker = ticker;
